...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        private void AddChannelToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            intfCANSignal = new CANSignal(ref dbcFileInfo, IntfCANDriver, csv, new CSVFileOperation("C:\\Users\\shawphon\\Desktop\\"+"Device" + commuForm.DevInd.ToString() + "-CANInd" + commuForm.CanInd.ToString()+".csv")); //连接之后做的事情 创建Signal对象
        ...
        private void Timer0_Tick(object sender, EventArgs e)
        {
            ...
            foreach (var textBox in TransGroup.Controls)
            {
                if (textBox is MyTextBox)
                {
                    ...
                    string[] str = textBox1.Name.Split(' ');     //str[0]: MessageID, str[1]: SiganlName
                    try
                    {
